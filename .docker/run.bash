...
CUSTOM_VOLUMES=(
    ...
    "${HOME}/.nvidia-omniverse/docker/cache/kit:/root/isaac_sim/kit/cache:rw"
    "${HOME}/.nvidia-omniverse/docker/cache/ov:/root/.cache/ov:rw"
    "${HOME}/.nvidia-omniverse/docker/cache/pip:/root/.cache/pip:rw"
    "${HOME}/.nvidia-omniverse/docker/data:/root/.local/share/ov/data:rw"
    "${HOME}/.nvidia-omniverse/docker/documents:/root/Documents:rw"
    "${HOME}/.nvidia-omniverse/docker/logs:/root/.nvidia-omniverse/logs:rw"
)
