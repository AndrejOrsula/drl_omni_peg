    ...
    pyo3::Python::with_gil(|py| {
        ...
        match MODE {
            Mode::Train => {
                ...
                let learning_rate = 0.0001_f64.into_py(py);
                ...
                agent
                    .learn(py, 100_000_000, checkpoint_callback, 1, "TRPO", true, false)
                    .map_err(|e| {
            ...
            Mode::Eval => {
                ...
                let model = sb3::contrib::trpo::TRPO::load(
                    py,
                    &load_model_path,
                    env,
                    device.as_ref(py),
